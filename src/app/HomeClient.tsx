...
export default function HomeClient({ recentVideos, popularVideos }: HomeClientProps) {
      ...
      <div className="flex flex-col min-h-screen overflow-x-hidden">
            ...
            <div className="relative bg-transparent rounded-[2.5rem] shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 px-5 md:px-12 lg:px-16 py-6 md:py-12">
                ...
                >
                  ...
                  >
                    <Link href="/colleges" className="inline-flex items-center justify-center h-14 md:h-14 px-10 md:px-10 text-lg md:text-lg font-semibold bg-[#f6c804] hover:bg-[#e5b703] text-black rounded-full hover:scale-105 hover:shadow-[0_0_30px_rgba(246,200,4,0.5)] transition-all duration-300">
        ...
        <section id="features-section" className="w-full py-20 md:py-32">
          <LayoutContainer>
            ...
            >
              <m.h2 variants={fadeInUp} className="text-3xl md:text-4xl lg:text-5xl font-bold">
                Why Choose <span className="gradient-text-yellow">Us?</span>
              </m.h2>
              <m.p variants={fadeInUp} className="text-muted-foreground text-lg max-w-2xl mx-auto">
          ...
          <LayoutContainer>
            ...
            >
              {featuredColleges.map((college, index) => (
                <m.div key={college.id} variants={fadeInUp}>
            ...
            >
              <Link href="/colleges" className="inline-flex items-center justify-center rounded-full px-8 hover:scale-105 transition-all duration-300 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-11 text-base">
          ...
          >
            <div className="text-center space-y-6 py-12 md:py-16 px-4 md:px-0">
              ...
              >
                ...
                <a href="https://wa.me/919874878782" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center h-14 px-8 text-lg font-semibold rounded-full border border-green-500/50 bg-green-500/10 text-green-500 hover:bg-green-500/20 hover:border-green-500 transition-all duration-300">
                  <svg viewBox="0 0 24 24" className="mr-2 h-5 w-5 fill-current group-hover:scale-110 transition-transform" aria-hidden="true">
