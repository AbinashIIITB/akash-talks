...
import { Calendar, CheckCircle2, Phone, ExternalLink, FileText, ChevronRight, HelpCircle, BookOpen, Clock, AlertCircle } from "lucide-react";
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <section id="eligibility" className="scroll-mt-28 space-y-4">
                                    <h2 className="text-2xl font-bold flex items-center gap-2">
                                        <CheckCircle2 className="h-6 w-6 text-[#f6c804]" /> Eligibility
                                    </h2>
                                    ...
                                    <div className="bg-card border rounded-2xl p-6 h-full">
                                        <ul className="space-y-3">
                                            {exam.documents.map((doc, idx) => (
                                                <li key={idx} className="flex items-start gap-3 text-muted-foreground">
                                                    <div className="h-1.5 w-1.5 rounded-full bg-[#f6c804] mt-2.5 flex-shrink-0" />
                                                    <span>{doc}</span>
                                                </li>
                                            ))}
                                        </ul>
