...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      {/* CTA Section */}
      <section id="cta-section" className="w-full py-20 md:py-32 relative overflow-hidden">
        {/* Background with gradient mesh */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a]" />
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#f6c804]/20 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#f6c804]/10 rounded-full blur-[120px]" />
        </div>
            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
              <div className="text-center space-y-6">
                <motion.div variants={fadeInUp} className="flex justify-center">
                  <span className="px-4 py-1.5 rounded-full bg-[#f6c804]/10 border border-[#f6c804]/30 text-[#f6c804] text-sm font-medium">
                    Start Your B.Tech Journey Today
                  </span>
                </motion.div>

                <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
                  Ready to Start Your <span className="text-[#f6c804]">Journey?</span>
                </motion.h2>

                <motion.p variants={fadeInUp} className="max-w-xl mx-auto text-white/70 text-lg">
                ...
                <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                  <Link href="/contact">
                    <Button size="lg" className="h-14 px-10 text-lg font-semibold bg-[#f6c804] text-black hover:bg-[#e5b703] rounded-full hover:scale-105 transition-all duration-300 shadow-lg shadow-[#f6c804]/25">
                      <Phone className="mr-2 h-5 w-5" />
                      Book Free Consultation
                    </Button>
                  </Link>
                  <Link href="https://wa.me/919874878782" target="_blank">
                    <Button size="lg" variant="outline" className="h-14 px-8 text-lg font-semibold rounded-full border-white/20 text-white hover:bg-white/10 transition-all duration-300">
                      <svg viewBox="0 0 24 24" className="mr-2 h-5 w-5 fill-current text-green-500">
                ...
                <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-6 pt-6 text-sm text-white/50">
                  {companyInfo.phones.map((phone) => (
                    <a key={phone} href={`tel:${phone.replace(/\s/g, '')}`} className="flex items-center gap-2 hover:text-[#f6c804] transition-colors">
                      <Phone className="h-4 w-4" /> {phone}
                    </a>
