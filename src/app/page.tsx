      ...
      >
        ...
        >
          <div className="text-center space-y-6 py-12 md:py-16">
            ...
            >
              <Link href="/contact">
                <Button size="lg" className="group h-14 px-10 text-lg font-semibold bg-[#f6c804] text-black hover:bg-[#e5b703] rounded-full transition-all duration-300 shadow-lg shadow-[#f6c804]/25 hover:shadow-[#f6c804]/40 hover:scale-105">
                  <Phone className="mr-2 h-5 w-5 group-hover:animate-pulse" />
                  Book Free Consultation
                </Button>
              </Link>
              <Link href="https://wa.me/919874878782" target="_blank">
                <Button size="lg" variant="outline" className="group h-14 px-8 text-lg font-semibold rounded-full border-white/20 text-white hover:bg-white/10 hover:border-[#f6c804]/50 transition-all duration-300">
                  <svg viewBox="0 0 24 24" className="mr-2 h-5 w-5 fill-current text-green-500 group-hover:scale-110 transition-transform">
