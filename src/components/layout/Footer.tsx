...
function LazyMap() {
    ...
    return (
        <div ref={containerRef} className="w-full h-48 rounded-2xl overflow-hidden border border-gray-800 relative bg-gray-900">
            {isVisible ? (
                <iframe
                    width="100%"
                    height="100%"
                    ...
                    aria-label="Google Maps showing Akash Talks office at Aurora Waterfront, Kolkata"
                    allowFullScreen
                ></iframe>
            ) : (
            ...
            <footer className="w-full bg-[#020617] rounded-[2.5rem] p-8 md:p-12 text-white overflow-hidden relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 relative z-10">
                    ...
                    <div className="space-y-10">
                        ...
                        <nav aria-label="Footer navigation" className="flex flex-col space-y-4 text-gray-300">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Action Buttons - Fixed nested interactive elements */}
                        <div className="flex gap-4 pt-2">
                            <Link
                                href="/contact"
                                className="flex-1 bg-[#1e293b] hover:bg-[#f6c804] hover:text-[#020617] text-[#f6c804] border border-[#f6c804]/20 py-4 rounded-xl flex items-center justify-center gap-2 font-medium transition-all duration-300 group"
                            >
                                Contact Us
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-[#1e293b] hover:bg-[#25D366] hover:text-white text-[#25D366] border border-[#25D366]/20 p-4 rounded-xl transition-all duration-300"
                                aria-label="Contact us on WhatsApp"
                            >
                                <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
