                ...
                <div className="flex items-center space-x-4">
                    ...
                    <Sheet>
                        <SheetTrigger asChild>
                            <Button variant="ghost" size="icon" className="md:hidden rounded-full h-9 w-9 transition-transform duration-200 hover:scale-110 active:scale-95">
                        ...
                        <SheetContent side="top" hideCloseButton className="w-full h-[100dvh] p-0 border-none flex flex-col" style={{ backgroundColor: mounted ? (resolvedTheme === 'dark' ? '#0f172b' : '#f8fafc') : '#f8fafc' }}>
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-dashed border-border/50">
                                ...
                                <div className="flex items-center gap-3">
                                    <Search />
                                    <SheetTrigger asChild>
                                        <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full transition-transform duration-200 hover:rotate-90 hover:scale-110 active:scale-95">
                                            <X className="h-4 w-4" />
                                        </Button>
                                    </SheetTrigger>
                                </div>
                            ...
                            <div className="p-6 pb-8 space-y-4 mt-auto" style={{ backgroundColor: mounted ? (resolvedTheme === 'dark' ? '#0f172b' : '#f8fafc') : '#f8fafc' }}>
                                ...
                                <SheetClose asChild>
                                    <Link href="https://wa.me/919874878782" target="_blank" className="flex items-center justify-center gap-2 text-[#25D366] font-semibold hover:opacity-80 transition-opacity">
